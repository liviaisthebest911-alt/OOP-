...
class DiscountCandy implements Candy{
    ...
    public DiscountCandy(String productId,String productName,double rating,int quantity, double discountAmount) {
    ...
    public boolean canGetDiscount() {
        if(quantity >= 10 && rating >= 8 ) return true;
        return false;
    }
